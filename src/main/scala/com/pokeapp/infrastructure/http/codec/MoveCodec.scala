...
// Decoders Circe para deserializar la respuesta JSON de /move/{id} al modelo de dominio.
object MoveCodec:

  // Deserializa la descripción del efecto del movimiento en un idioma del array "effect_entries"
  ...
  // Deserializa los metadatos de combate avanzados del campo "meta" del movimiento
  ...
  // Decoder raíz que une todos los campos del objeto move de PokeAPI
